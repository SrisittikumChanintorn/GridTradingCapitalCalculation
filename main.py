...
with st.container():
    ...
    st.write('')
    st.markdown(f"<p style='font-size:20px;'><strong>Cost of First Investment   :</strong> {first_action_cost} USD</p>", unsafe_allow_html=True)
    st.markdown(f"<p style='font-size:20px;'><strong>Remaining Funds            :</strong> {reminding_funds} USD</p>", unsafe_allow_html=True)
    st.markdown(f"<p style='font-size:20px;'><strong>Total Funds Used           :</strong> {used_funds} USD</p>", unsafe_allow_html=True)
    st.markdown(f"<p style='font-size:20px;'><strong>Fund A Investment Size     :</strong> {lot_size_fundA} per zone, <strong>Total Cost:</strong> {Total_fundA_price} USD</p>", unsafe_allow_html=True)
    st.markdown(f"<p style='font-size:20px;'><strong>Fund B Investment Size     :</strong> {lot_size_fundB} per zone, <strong>Total Cost:</strong> {Total_fundB_price} USD</p>", unsafe_allow_html=True)
